...
function updateTime(){
    ...
    document.getElementById('songTimeLength').innerHTML=Math.floor(activeSong.duration / 60) + ":" + (Math.floor(activeSong.duration % 60) < 10 ? '0' : '') + Math.floor(activeSong.duration % 60);
